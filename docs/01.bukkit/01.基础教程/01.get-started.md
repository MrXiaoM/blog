...
![01](https://static.mcio.dev/legacy/67eea44d0ba3d5a1d7ec4971.webp)
...
![02](https://static.mcio.dev/legacy/67eea44e0ba3d5a1d7ec4973.webp)

先打开 `build.gradle.kts` 待命，点击左侧的「构建」标签页，等待同步完成  
![03](https://static.mcio.dev/legacy/67eea4490ba3d5a1d7ec495f.webp)
...
![04](https://static.mcio.dev/legacy/67eea4490ba3d5a1d7ec4960.webp)

## 新建主类

在「项目」下面依次展开 `src`、`main`，在 `java` 文件夹上右键，点击「新建」->「软件包」

![05](https://static.mcio.dev/legacy/67eea44c0ba3d5a1d7ec496a.webp)

在弹出的输入框填入包名。包名由 **组ID** 和 **软件名（全小写）** 组成，用 `.` 连接。  
这里使用 `org.example.exampleplugin`，请改成你自己的包名。

![06](https://static.mcio.dev/legacy/67eea44b0ba3d5a1d7ec4966.webp)
...
![07](https://static.mcio.dev/legacy/67eea4a90ba3d5a1d7ec49fa.webp)

在左花括号`{`前面加 `extends JavaPlugin`，将鼠标悬停到 **红色字(报错)** 上面，点击`导入类`。

![08](https://static.mcio.dev/legacy/67eea4a60ba3d5a1d7ec49f7.webp)
...
![09](https://static.mcio.dev/legacy/67eea4a70ba3d5a1d7ec49f8.webp)
...
![10](https://static.mcio.dev/legacy/67eea4a50ba3d5a1d7ec49f5.webp)

主类路径可以通过右键主类，点击「复制路径/引用…」->「复制引用」来获取。

![11](https://static.mcio.dev/legacy/67eea4a70ba3d5a1d7ec49f9.webp)
...
![12](https://static.mcio.dev/legacy/67eea4a60ba3d5a1d7ec49f6.webp)

左侧转到「运行」标签页，出现「成功」、「BUILD SUCCESSFUL in XX」就代表成功了。

![13](https://static.mcio.dev/legacy/67eea4eb0ba3d5a1d7ec4a47.webp)

构建出来的插件 jar 会出现在 build/libs 文件夹里，复制到你的服务器里测试吧！

![14](https://static.mcio.dev/legacy/67eea4e50ba3d5a1d7ec4a2f.webp)

![15](https://static.mcio.dev/legacy/67eea4ea0ba3d5a1d7ec4a3e.webp)
...
![16](https://static.mcio.dev/legacy/67eea4e70ba3d5a1d7ec4a30.webp)
...
![17](https://static.mcio.dev/legacy/67eea4e90ba3d5a1d7ec4a37.webp)
