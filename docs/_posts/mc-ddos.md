...
![](https://static.mcio.dev/legacy/66ea3cadf21886ccc0197119.webp)
...
![](https://static.mcio.dev/legacy/66ea3e0cf21886ccc01adbf7.webp)
...
> 由于 hopper-rs 已经不再更新，我已经改用 HAProxy，详见[我的新文章](/post/minecraft-haproxy-redirect-by-domain)，这篇文章的过时部分将被折叠。
...
![](https://static.mcio.dev/legacy/66ea4c17f21886ccc030ed1f.webp)
...
这还不够，我修改了 fail2win，使得所有试图登录 Administrator 失败的 IP 都有 50% 的几率被添加到防火墙黑名单。正如你所见，我禁用了远程控制登录，登录 Administrator 必失败，这个账户变成了一个捕兽夹，封禁了非常多肉鸡的 IP。[如图所示](https://static.mcio.dev/legacy/66ea4e61f21886ccc033255c.webp)，图太大了，就只放链接吧。
