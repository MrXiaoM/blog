...
右上角会显示导出详情，如果你想进一步优化，减少多边形数量，可以拉一下 `Reduce Polygons` 里面的滑块。

需要注意的是，你需要保证最终 `Polygons` 的值小于 `65535`，推荐在 `32000` 左右最为合适。

都调整好之后，点击 `Export` 导出，选择 `VRM 0.0`，填写名字和作者，其它的不用填，直接导出。

![](https://static.mcio.dev/legacy/68df6eabc5157e1a885303a6.webp)
...
![](https://static.mcio.dev/legacy/68e3799ec5157e1a8859ba0d.webp)
...
![](https://static.mcio.dev/legacy/68e353fec5157e1a88599ff4.webp)
